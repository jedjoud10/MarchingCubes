...
Shader "Custom/NewTerrainShader2" {
    Properties{
        ...
        /* UNITY: Original start of shader */
                    ...
                    struct v2f_surf {
                      ...
                      nointerpolation float4 custompack1 : TEXCOORD4; // vertColor
                    ...
                    struct v2f_surf {
                      ...
                      float4 tSpace2 : TEXCOORD2;
                      float3 custompack0 : TEXCOORD3; // cameraRelativeWorldPos
                      nointerpolation nointerpolation float4 custompack1 : TEXCOORD4; // vertColor
                      float4 lmap : TEXCOORD5;
                      UNITY_FOG_COORDS(6)
                      UNITY_SHADOW_COORDS(7)
                      UNITY_VERTEX_INPUT_INSTANCE_ID
                    ...
                    v2f_surf vert_surf(appdata_full v) {
                      ...
                      o.custompack1.xyzw = customInputData.vertColor;
    ...
    CGPROGRAM
                                                                      ...
                                                                      /* UNITY: Original start of shader */
                                                                                  ...
                                                                                  struct v2f_surf {
                                                                                    ...
                                                                                    nointerpolation float4 custompack1 : TEXCOORD5; // vertColor
                                                                                    UNITY_LIGHTING_COORDS(6,7)
                                                                                    UNITY_FOG_COORDS(8)
                                                                                    UNITY_VERTEX_INPUT_INSTANCE_ID
                                                                                    UNITY_VERTEX_OUTPUT_STEREO
